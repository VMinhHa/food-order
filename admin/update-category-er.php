    ...
    <div class="wrapper">
        ...
        <?php
            ...
            if(isset($_GET['id']))
            {
                ...
                //Count the Rows check whether id is valid or not
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        if($current_image!="")
                        {
                            $remove_patch = "../images/category/".$current_image;
                            $remove = unlink($remove_patch);
                ...
                //4. Redirect to Manage Category with Messsage
                if($res2==true)
                {
                    //Category Update
